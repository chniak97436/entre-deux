...
export default function Footer() {
  return (
    <div className='w-full relative p-4 bg-b flex flex-1/3 flex-col md:flex-row justify-between items-center gap-4'>
      <div className='w-full flex flex-col md:w-1/3 justify-center items-center md:items-start text-center text-sm text-v'>
      ...
      <div className='w-full flex flex-col md:w-1/3 justify-center items-center text-center text-sm text-v'>
        ...
        <p>Lundi-Vendredi : 8h00 - 12h00 / 13h30 - 16h30</p>
